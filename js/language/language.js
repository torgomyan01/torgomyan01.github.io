const translateKeys = [
    ...
    },
    {
        key: 'header_title',
        am: 'Ունես Բիզնես՞',
        ru: 'У вас есть бизнес?'
    },
    {
        key: 'header_subtitle',
        am: 'Ցանկացած ժամանակակից բիզնես, պետք է ունենա իր կայքը',
        ru: 'Любой современный бизнес должен иметь свой сайт'
    },
    {
        key: 'key_2',
        am: `
            Քո բիզնեսը, կարող է ունենալ մինչև 2 անգամ ավել եկամուտ ինչպես նաև կկարողանաք ավելի արագ, և ճիշտ կառավարել։ <br>
            Մենք, Ձեզ հնարավորություն ենք տալիս ունենալ Ձեր կայքը սե՛ղմ ժամկետներում, և՛ ամենահարմար գներով․ <br>
            Ինչպես նաև, մեր առաջին համագործակցության ժամանակ կունենաք նաև զեղչեր։
        `,
        ru: `
            Ваш бизнес может иметь доход до 2 раз больше и вы сможете управлять им быстрее и правильно. <br>
             Мы даем Вам возможность иметь свой сайт в короткие сроки и по самым удобным ценам. <br>
             Также у вас будут скидки при первом сотрудничестве.
        `
    },
    {
        key: 'btn-header1',
    ...
    {
        key: 'head1',
        am: `Ակնկալիքներ մեզանից`,
        ru: 'Ожидания от нас',
    },
    {
        key: 'p1',
        am: `<span>Նորարարություն և ստեղծագործականություն.</span> 
            Մենք ստեղծում ենք ժամանակակից վեբ նախագծեր և կրթական ծրագրեր, որոնք միշտ մեկ քայլ առաջ են միտումներից:`,
        ru: `
    ...
    {
        key: 'p2',
        am: `<span>Պրոֆեսիոնալ թիմ.</span> 
            Մեր փորձառու մշակողները և հրահանգիչները ապահովում են ամենաբարձր մակարդակի գիտելիքներն ու հմտությունները:
            `,
        ru: `
    ...
    {
        key: 'p3',
        am: `<span>Գործնական փորձ.</span> Սովորել\` անելով: Ուսանողները լուծում են իրական խնդիրներ, պատրաստվելով հաջող կարիերայի։
        `,
        ru: `
    ...
    {
        key: 'p4',
        am: `<span>Ճկունություն և անհատականություն.</span> 
            Մեր ծրագրերը հարմար են հմտությունների բոլոր մակարդակների համար, և ճկուն գրաֆիկները հարմարեցված են Ձեզ համապատասխան:
            `,
        ru: `
    ...
    {
        key: 'p5',
        am: `<span>Ոգեշնչող համայնք. </span> Դուք դառնում եք ակտիվ համայնքի մի մասը, որտեղ Ձեր գաղափարները աջակցվում են:`,
        ru: `
    ...
    {
        key: 'p6',
        am: `<span>Իրական արդյունքներ</span> 
            շրջանավարտները հաջողությամբ կիրառում են գիտելիքները, սկսելով կարիերա ՏՏ ոլորտում, կամ սկսելով իրենց սեփական նախագծերը:
            `,
        ru: `
